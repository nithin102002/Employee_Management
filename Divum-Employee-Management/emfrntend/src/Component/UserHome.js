...
function applyleave(){
    ...
    <option  value="DOB">Sort By DOB</option>
            ...
            <div className="table">
                ...
                {/* <button id='userEdit'>Edit</button>
                <button id='userDelete'>Delete</button> */}
                  <button id='userEdit' onClick={() => navigate(`/put/${id}`)}>Edit</button>
                  <button id='userDelete' onClick={() => handleDelete(id)}>Delete</button>
                  <button id='applyleave' onClick={()=>applyleave()}>Apply Leave</button>
